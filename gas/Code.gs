...
// ⚠️ ล้างรายการทุกครั้งหลังรันเสร็จ — รัน applyTableMoves() ซ้ำ = สลับกลับที่เดิม
const TABLE_MOVES = [
  // สลับ 7 ↔ 6 (Nueng สั่ง 9 ก.ย. 2026)
  [7, 6],    // เพื่อนเจ้าสาว (อว.) 5 รายชื่อ   → โต๊ะ 6
  [6, 7],    // ญาติเจ้าสาว (ปลื้ม) ยังไม่มีชื่อ → โต๊ะ 7

  // สลับ 25 ↔ 24 (Nueng สั่ง 9 ก.ย. 2026)
  [25, 24],  // ญาติพ่อเจ้าบ่าว 8 รายชื่อ      → โต๊ะ 24
  [24, 25],  // ญาติแม่เจ้าบ่าว ยังไม่มีชื่อ    → โต๊ะ 25
];

/* ประวัติการย้ายที่ทำไปแล้ว (ดูรายละเอียดเต็มได้ในชีต Log):
   9 ก.ย. 2026 — สลับ 6 ↔ 4 : ATC (7 รายชื่อ) ไปโต๊ะ 4 · ปลื้ม ไปโต๊ะ 6 */
